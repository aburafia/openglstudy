...
-(void)renderingEdge:(mat4*)matdata{
    ...
    vec3raw* pospt = &pmdfile->_result.vertices->position;
    glVertexAttribPointer(_attr_pos_edge, 3, GL_FLOAT, GL_FALSE, sizeof(PmdVertex), (GLvoid*)pospt);
    
    vec3raw* normalpt = &pmdfile->_result.vertices->normal;
    glVertexAttribPointer(_attr_normal_edge, 3, GL_FLOAT, GL_FALSE, sizeof(PmdVertex), (GLvoid*)normalpt);
