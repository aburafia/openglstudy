...
//            
//            [pmdmanager sjis2utf8:m->diffuse_texture_name];
//            [pmdmanager sjis2utf8:m->extra.effect_texture_name];
//
//
//        }
//
...
//        [pmdmanager sjis2utf8:bone->name];
//
//
...
//
//    if (!name[0] || !texList == nil) {
//        // 空文字の場合はNULLを返す
//        return NULL;
//    }
//
//    int i = 0;
//    for (i = 0; i < texList->texture_count; ++i) {
//        // 名前が一致したらそれを返す
//        if (strcmp(texList->texturelist[i].filename, name) == 0) {
//            return texList->texturelist[i];
//        }
//    }
//
//    return NULL;
